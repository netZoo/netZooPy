...
# WGBSdir=$3
WGBSdir='data/MotifPipeline/MeArrayintersectFULLshuf/test' ## chr start end tmp Me-value, multiple per cell line
...
then
	...
	awk '{print $1,$2,$3,$4,$5,$6,$7,$8,$9,$13,$14,$19}' OFS='\t' temp.txt > $WGBSdir/$out #$motifdir$out
