...
def compute_panda_gpu(
    ...
    ppi_matrix = cp.array(ppi_matrix.copy(), dtype = np.int16)
    motif_matrix = cp.array(motif_matrix.copy(), dtype = np.int16)
    correlation_matrix = cp.array(correlation_matrix.copy(), dtype = np.int16)
