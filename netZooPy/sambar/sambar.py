...
esize = pkg_resources.resource_filename(__name__, '../tests/sambar/ToyData/esizef.csv')
genes = pkg_resources.resource_filename(__name__, '../tests/sambar/ToyData/genes.txt')
sign  = pkg_resources.resource_filename(__name__, '../tests/sambar/ToyData/h.all.v6.1.symbols.gmt')
mut   = pkg_resources.resource_filename(__name__, '../tests/sambar/ToyData/mut.ucec.csv')
