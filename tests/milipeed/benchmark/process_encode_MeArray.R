...
RGSet<-minfi::read.metharray.exp("data/MotifPipeline/ENCODE/methyl_array/idats/850k/")
...
write.table(beta[,1],'data/MotifPipeline/ENCODE/methyl_array/A-549c.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
write.table(beta[,2],'data/MotifPipeline/ENCODE/methyl_array/GM12878c.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
write.table(beta[,3],'data/MotifPipeline/ENCODE/methyl_array/HeLa-S3c.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
write.table(beta[,4],'data/MotifPipeline/ENCODE/methyl_array/Hep-G2c.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
write.table(beta[,5],'data/MotifPipeline/ENCODE/methyl_array/K562c.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
write.table(beta[,6],'data/MotifPipeline/ENCODE/methyl_array/SKNSHc.txt',sep ='\t',quote = FALSE,dec = '.',col.names = FALSE)
...
paste chrc.txt startc.txt A-549c.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> A-549_MeArrayc.txt
paste chrc.txt startc.txt GM12878c.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> GM12878_MeArrayc.txt
paste chrc.txt startc.txt HeLa-S3c.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> HeLa-S3_MeArrayc.txt
paste chrc.txt startc.txt Hep-G2c.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> Hep-G2_MeArrayc.txt
paste chrc.txt startc.txt K562c.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> K-562_MeArrayc.txt
paste chrc.txt startc.txt SKNSHc.txt R2islandc.txt| awk '{print $1,$2,$2+1,$4,$5}' OFS='\t'> SK-N-SH_MeArrayc.txt

# 
# ##map from 19 to 38 cd to data (from data folder on laptop)
...
me=read.csv('data/MotifPipeline/ENCODE/methyl_array/crossQC/A-549_MeArrayHG38b.txt',sep='\t',header=FALSE)#,usecols=[0,1,2],sep='\t',names=['chr','start','end'])
me$V4<-NULL
me$V5<-NULL
chip$V4<-NULL
